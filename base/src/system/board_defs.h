...
#define AHB_TARGET (D1_TARGET/2)     //< Target Hz for AHB peripherals
/* APB 1, 2 & 4 are divided from AHB clock. */
#define APB1_TARGET (AHB_TARGET/4)   //< Target Hz for APB1 peripherals
#define APB2_TARGET (AHB_TARGET/4)   //< Target Hz for APB2 peripherals
#define APB4_TARGET (AHB_TARGET/4)   //< Target Hz for APB4 peripherals
